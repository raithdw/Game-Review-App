  ...
  <table class="table table-hover fixed">
    ...
    <tbody>
        <?php 
          ...
          $query = "SELECT * from users where user_type = 'employee' LIMIT $start, $limit";
          $result = mysqli_query($conn, $query);
          $query2 = "SELECT COUNT(*) rev FROM reviews, users where reviews.users_id = users.id";
            ...
            while ($myrow=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
              ?>
                <tr>
                  ...
                  <td><a class="text-decoration-none" href="http://localhost/GameReviewApp/UserReviews.php"><?php while ($myrow2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) { echo $myrow2["rev"]; break;} ?></a></td>
                  <td><a class="text-decoration-none" href="http://localhost/GameReviewApp/EditEmployee.php?id=<?php echo $myrow["id"]; ?>">View Employee details</a></td>
                </tr>
          <?php 
          ...
          ?>
        <?php
        $rows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users where user_type = 'employee'"));
