...
<html>
<head>
	<title>Employee Dashboard - GRA</title>
	<meta charset="utf-8">
...
<div class="container content">
  ...
  <br>  
  <div class="col">
      <a href="http://localhost/GameReviewApp/AddReview.php" button type="button" class="btn btn-danger">Add Review</button></a>
  </div>
  ...
  <table class="table table-hover fixed">
    ...
    <tbody>
      <?php 
          ...
          $query = "SELECT * from reviews WHERE users_id = '$user_id' LIMIT $start, $limit";
          $result = mysqli_query($conn, $query);
          $query2 = "SELECT review_title, COUNT(reviews.id) as com from reviews Join user_comments WHERE user_comments.review_id = reviews.id GROUP BY reviews.id";
          ...
          ?>
                <tr>
                  ...
                  <td><?php while ($myrow2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) { echo $myrow2["com"]; break;} ?></td>
                  <td><?php echo $myrow["like_count"]; ?></td>
                  <td><a class="text-decoration-none" href="http://localhost/GameReviewApp/EditReview.php?id=<?php echo $myrow["id"]; ?>">Edit review</a></td>
                </tr>
          <?php 
