              ...
              <div class="row">
                <div class="col-12 col-sm-auto mb-3">
                  <div class="mx-auto" style="width: 150px;">
                    <div class="d-flex justify-content-center align-items-center rounded" style="height: 170px; background-color: rgb(255, 255, 255);">
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="password"  name="current_pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
...
<script src="https://kit.fontawesome.com/9b37347340.js" crossorigin="anonymous"></script>
  ...
  <?php
      if(isset($_POST['submit'])){
        ...
        $email = $_POST['email'];
        $about = $_POST['about'];
        $password_1 = $_POST['current_pass'];
        $password_2 = $_POST['new_pass'];
        $password_3 = $_POST['conf_pass'];

        $query = "UPDATE users SET first_name = '$first_name',
                      last_name = '$last_name', username = '$username', email = '$email', about = '$about'
                      WHERE id = '$user_id'";
                    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));


        if (($myrow['password'] == $password_1) && ($password_2 == $password_3)) {
              $quer = "UPDATE users SET password = '$password_2' WHERE id = '$user_id'";
              $res = mysqli_query($conn, $quer) or die(mysqli_error($conn));
           }
        else {
  ...
  ?>
        <script type="text/javascript">
            ...
            window.location = "UserEditPage.php";
        </script>
        <?php
      }
