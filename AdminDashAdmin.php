...
<html>
<head>
	<title>Admin Dashboard Admin - GRA</title>
	<meta charset="utf-8">
  ...
  <table class="table table-hover fixed">
    ...
    <tbody>
        <?php 
          ...
          $query = "SELECT * from users WHERE user_type = 'admin' LIMIT $start, $limit";
          $result = mysqli_query($conn, $query);
          $query2 = "SELECT COUNT(*) rev from reviews WHERE users_id = 11";
          ...
          ?>
        <?php
        $rows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users where user_type = 'admin'"));
