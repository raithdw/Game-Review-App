...
<html>
<head>
	<title>Admin Dashboard User - GRA</title>
	<meta charset="utf-8">
    ...
    <span class="navbar-toggler-icon"></span>
  	...
  	<div class="collapse navbar-collapse" id="bs-nav-demo">
    	<ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item">
            <a class="nav-link" href="http://localhost/GameReviewApp/AdminDash.html">Dashboard</a>
          </li>
    	</ul>
    	<ul class="navbar-nav">
        <li>
...
<div class="container content">
  ...
  <div class="row justify-content-center mb-2">
    <div class="col">
      <h3>Select To View and Add Account Types</h3>
      <a href="http://localhost/GameReviewApp/AddAccount.php" button type="button" class="btn btn-danger pull-right">Add Account</button></a>
      <a href="http://localhost/GameReviewApp/AdminDash.php" button type="button" class="btn btn-danger">Employee</button></a>
      <a href="http://localhost/GameReviewApp/AdminDashUser.php" button type="button" class="btn btn-danger">User</button></a>
      <a href="http://localhost/GameReviewApp/AdminDashAdmin.php" button type="button" class="btn btn-danger">Admin</button></a>
    </div>
  </div>
    ...
    <tbody>
      <tr>
         <?php 
          ...
          $query = "SELECT * from users WHERE user_type = 'user' LIMIT $start, $limit";
          $result = mysqli_query($conn, $query);
          $query2 = "SELECT COUNT(*) com from user_comments WHERE users_id = '$id'";
            ...
            while ($myrow=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
              ?>
                <tr>
                  ...
                  <td><a class="text-decoration-none" href="http://localhost/GameReviewApp/ReviewDescription.php"></td>
                  <td><a class="text-decoration-none" href="http://localhost/GameReviewApp/EditUser.php?id=<?php echo $myrow["id"]; ?>">View User details</a></td>
                </tr>
          <?php 
          ...
          ?>
        <?php
        $rows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users where user_type = 'user'"));
